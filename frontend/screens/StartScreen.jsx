...
export default function StartScreen({ learnerId, onLearnerIdChange, onContinue }) {
  return (
    <div className="start-screen-wrapper">
      <MagBackground theme="light" density={200} particlesScale={0.7} />
      <div className="start-screen glass-card">
        <div className="start-kicker">
          <span className="kicker-dot" /> Adaptive learning workspace
        </div>
        <h1>
          Find your gaps.<br />
          <em>Close them in order.</em>
        </h1>
        <p className="tagline">
        ...
        <div className="start-notes">
          <span>
            <strong>01</strong> Diagnose
          </span>
          <span>
            <strong>02</strong> Practice
          </span>
          <span>
            <strong>03</strong> Retest
          </span>
        </div>
      </div>
    </div>
